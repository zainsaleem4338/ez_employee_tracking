...
(function ($) {
    ...
    var eCalendar = function (options, object) {
        ...
        var mouseClickItem = function (event) {
            $('.c-event-item').slideUp('show');
            // $(this).removeClass('collapsed');
            $('.'+event.data[0]).slideDown('slow');
        };
        ...
        function print() {
                ...
                if (i < dWeekDayOfMonthStart) {
                    ...
                    for (var j = 0; j < settings.events.length; j++) {
                        ...
                        if (d.getDate() == day && d.getMonth() == dMonth && d.getFullYear() == dYear) {
                            ...
                            let data = cDay.attr('title');
                            if (data === undefined){
                              data = 0;
                              cDay.on('click',[d.getDate()],mouseClickItem);
                            }
                            data = String(data);
                            data = data.replace ( /[^\d.]/g, '' );
                            data = parseInt(data) + 1;
                            cDay.attr('title', 'Total events today: ' + String(data));
            ...
            for (var i = 0; i < settings.events.length; i++) {
                ...
                if (d.getMonth() == dMonth && d.getFullYear() == dYear) {
                    ...
                    var item = $('<div/>').addClass('c-event-item collapse ' + d.getDate());
