Rails.application.routes.draw do
  ...
  # get 'project/:project_id/new_task' => 'tasks#new', as: :new_task_page
  # get 'projects/:project_id/tasks' => 'tasks#index', as: :tasks_page
  # get 'projects/:project_id/tasks/:id' => "tasks#edit", as: :edit_a_task_page
  # patch 'projects/:project_id/tasks/:id' => "tasks#update", as: :update_a_task_page
